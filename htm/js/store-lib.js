...
var sF$=(function(){
  ...
  //Nova Funcao Precohome
  function fnShowNewProd(Price,OriginalPrice,Cod,PrecoVista,iMaxParcels,ProductID){
    //função que mostra o preço do produto, parcelamento, desconto à vista e badge (home e lista)
    iPL++;
    var idPrice=fnGetID("idProdPrice"+ProductID);
    var sPrice="";
    ...
    if(Price!=OriginalPrice){
      sPrice+="<div class=\"prices\">";
      sPrice+="  <div class=\"old-price  line-through\" style=\"font-size: 12px;\">De&nbsp; <span>"+FormatPrice(OriginalPrice,FC$.Currency)+"</span></div>";
      sPrice+="  <div class=\"price home-price\"><span class=\"home-price-por\">Por </span>"+FC$.Currency + " " + fnFormatNumber(iPriceInt) +","+ "<span class=\"home-price-cents\">" + PriceDecimal + "</span>" +"</div>";
    }
    else{
      sPrice+="<div class=\"prices\">";
    ...
    //sPrice+="  <div class=\"installments\">(no boleto ou depósito bancário)</div>";
    //sPrice+="  <div class=\"installments\">ou&nbsp; <span>"+FormatPrice(Price,FC$.Currency)+"</span></div>";
    //sPrice+="  <div class=\"installments\">em até 3x sem juros no cartão de crédito</div>";
    ...
    if(oBadge){
      var sBadges="";
      if(oBadge.hasAttribute("data-sale") && OriginalPrice>Price)sBadges+="<div id='badgeProm"+ProductID+"' class='badgeProm' title='Oferta'>-" + fnGetSale() + "%</div>";
      if(oBadge.hasAttribute("data-release"))sBadges+="<div class='badgeNew' title='Lançamento'>&#10033;</div>";
